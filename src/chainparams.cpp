...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000003ad8e97e6074aa1035d9ba0a965b4de2eb552e37d7d2b396078b4501f28"));
...
std::string CChainParams::GetDevFeeRewardAddress()
{
	if(Params().NetworkID() == CBaseChainParams::TESTNET)
        return "DQo8wdrp1ovZdfSKHr4mzTuEhK5SkEUDuw";
	else
        return "DQo8wdrp1ovZdfSKHr4mzTuEhK5SkEUDuw";
}
...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1543955700; // Time (GMT): Thursday, 10 May 2018 13:19:53 - (Accumulator start time - requires block height 40000)
        ...
        const char* pszTimestamp = "GanjaCoin-Zero";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 250 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04eb80706f16457896e44daa6b384d3562a577911ecbc8988342d461002562fdffa7294abd3a44ca8bc52bc33e7f00c4319f5b7e6d66a1a544481cb2847b1bf0da") << OP_CHECKSIG;
        ...
        vSeeds.push_back(CDNSSeedData("140.82.2.143", "140.82.2.143"));   // Single node address
        ...
        nStartMasternodePayments = 1543955700; //Wed, 25 Jun 2014 20:36:16 GMT
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("0409889c2805c06fca1fa92b6845789f56950878712013259a203046c4d6e86809796d6a6b402ac7b7fb6235ee9d9d7e33bea8d4fb1b75ca044d24b5823a292e97");
        nDefaultPort = 51400;
        nEnforceBlockUpgradeMajority = 51;
        nRejectBlockOutdatedMajority = 75;
        nToCheckBlockUpgradeMajority = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // XORN: 1 day
        nTargetSpacing = 1 * 60;  // XORN: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nNonce = 380180;



	      hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000007aba150389076fd97770d792aa60ee5367b8d70cd7bf7aca5627473b364"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 138); // Testnet xorn addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet xorn script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet xorn BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet xorn BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet xorn BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51436;
        assert(hashGenesisBlock == uint256("0x000001f33e69828669b49abae38fd7717f28c04bf84cb20b7d0a26c71e658ae5"));
