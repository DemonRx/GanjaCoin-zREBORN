...
QT_MOC_LITERAL(6, 86, 26), // "anonymizeXORNAmountChanged"
QT_MOC_LITERAL(7, 113, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "zeromintPercentageChanged\0"
    "preferredDenomChanged\0anonymizeXORNAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->anonymizeXORNAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeXORNAmountChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void OptionsModel::anonymizeXORNAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
