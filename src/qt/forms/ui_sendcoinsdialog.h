...
public:
    ...
    QCheckBox *checkzXORN;
    QCheckBox *checkSwiftNode;
    QLabel *label;
    QLabel *labelBalance;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MRJA"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MRJA"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MRJA"));
        ...
        checkzXORN = new QCheckBox(SendCoinsDialog);
        checkzXORN->setObjectName(QStringLiteral("checkzXORN"));
        checkzXORN->setEnabled(false);

        horizontalLayout_2->addWidget(checkzXORN);

        checkSwiftNode = new QCheckBox(SendCoinsDialog);
        checkSwiftNode->setObjectName(QStringLiteral("checkSwiftNode"));
        checkSwiftNode->setEnabled(true);
        checkSwiftNode->setMinimumSize(QSize(85, 0));

        horizontalLayout_2->addWidget(checkSwiftNode);
        ...
        labelBalance->setText(QStringLiteral("123.456 MRJA"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 MRJA", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uMRJAs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uMRJAs in fee,<br />while \"at least\" pays 1000 uMRJAs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uMRJAs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uMRJAs in fee,<br />while \"total at least\" pays 1000 uMRJAs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for MRJA transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for MRJA transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzXORN->setText(QApplication::translate("SendCoinsDialog", "Anonymized MRJA", Q_NULLPTR));
        checkSwiftNode->setText(QApplication::translate("SendCoinsDialog", "SwiftNode", Q_NULLPTR));
