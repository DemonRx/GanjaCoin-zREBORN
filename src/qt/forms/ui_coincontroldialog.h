...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 XORN"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 XORN"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 XORN"));
