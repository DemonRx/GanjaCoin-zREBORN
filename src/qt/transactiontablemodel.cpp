...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted MRJA to zMRJA");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zMRJA");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received MRJA from zMRJA");
    case TransactionRecord::ZerocoinSpend_Change_zXORN:
        return tr("Minted Change as zMRJA from zMRJA Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zMRJA to MRJA");
...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return QIcon(":/icons/tx_mined");
    case TransactionRecord::MNReward:
        return QIcon(":/icons/tx_mnreward");
    case TransactionRecord::RecvWithObfuscation:
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
    case TransactionRecord::RecvFromZerocoinSpend:
