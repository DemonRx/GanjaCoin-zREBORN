                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MRJA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MRJA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MRJA: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMRJA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MRJA Core"), this);
    aboutAction->setStatusTip(tr("Show information about MRJA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MRJA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MRJA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MRJA addresses"));
    ...
    openAction->setStatusTip(tr("Open a MRJA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MRJA Core help message to get a list with possible MRJA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MRJA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MRJA network", "", count));
}
...
{
    QString strTitle = tr("MRJA Core"); // default title
...
/** Creates context menu, its actions, and xorns up all the relevant signals for mouse events. */
