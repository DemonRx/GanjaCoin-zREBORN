...
// Copyright (c) 2017 The GanjaCoin developers
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MRJA features */
        {"mrja", "masternode", &masternode, true, true, false},
        {"mrja", "listmasternodes", &listmasternodes, true, true, false},
        {"mrja", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mrja", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mrja", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mrja", "masternodedebug", &masternodedebug, true, true, false},
        {"mrja", "startmasternode", &startmasternode, true, true, false},
        {"mrja", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mrja", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mrja", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mrja", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mrja", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mrja", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mrja", "mnbudget", &mnbudget, true, true, false},
        {"mrja", "preparebudget", &preparebudget, true, true, false},
        {"mrja", "submitbudget", &submitbudget, true, true, false},
        {"mrja", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mrja", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mrja", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mrja", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mrja", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mrja", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mrja", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mrja", "checkbudgets", &checkbudgets, true, true, false},
        {"mrja", "mnsync", &mnsync, true, true, false},
        {"mrja", "spork", &spork, true, true, false},
        {"mrja", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mrja", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ganjacoind, or the -server option to ganjacoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ganjacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12310/\n";
}
