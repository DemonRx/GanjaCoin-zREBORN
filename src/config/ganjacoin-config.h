/* src/config/ganjacoin-config.h.  Generated from ganjacoin-config.h.in by configure.  */
/* src/config/ganjacoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ganjacoin_CONFIG_H

#define ganjacoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.ganjacoinpro.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GanjaCoin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GanjaCoin 1.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "GanjaCoin"
