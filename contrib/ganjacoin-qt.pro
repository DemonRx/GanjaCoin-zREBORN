...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ganjacoin-cli.cpp \
           src/ganjacoin-tx.cpp \
           src/ganjacoin.cpp \
           src/db.cpp \
           ...
           src/qt/ganjacoin.cpp \
           src/qt/ganjacoinstrings.cpp \
...
RESOURCES += src/qt/ganjacoin.qrc src/qt/ganjacoin_locale.qrc

TRANSLATIONS += src/qt/locale/ganjacoin_bg.ts \
                src/qt/locale/ganjacoin_de.ts \
                src/qt/locale/ganjacoin_en.ts \
                src/qt/locale/ganjacoin_es.ts \
                src/qt/locale/ganjacoin_fi.ts \
                src/qt/locale/ganjacoin_fr.ts \
                src/qt/locale/ganjacoin_it.ts \
                src/qt/locale/ganjacoin_ja.ts \
                src/qt/locale/ganjacoin_pl.ts \
                src/qt/locale/ganjacoin_pt.ts \
                src/qt/locale/ganjacoin_ru.ts \
                src/qt/locale/ganjacoin_sk.ts \
                src/qt/locale/ganjacoin_sv.ts \
                src/qt/locale/ganjacoin_vi.ts \
                src/qt/locale/ganjacoin_zh_CN.ts \
                src/qt/locale/ganjacoin_zh_TW.ts
